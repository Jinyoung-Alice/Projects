                  ...
                  <table>
                        ...
                        <tr>
                         ...
                         <tr>
                         	<td> 성별 : </td>
                         	<td>
                         	     <input type="radio" name="gender" id="M" /> 남성
                         	     <input type="radio" name="gender" id="F" /> 여성
                         	</td>
                         	<td></td>
                         </tr>
                         ...
                         <tr>
                         	<td> 나이 : </td>
                         	<td> 
                         	     <input type="text" name="age" min="5" max="80" value="<%= m.getAge()%>" />
                         	</td>
                         	<td></td>
                         </tr>
       ...
       <script>
             $(function() {
            	 ...
            	 $('#updateFrm').submit(function(event) {
            		  ...
            		  // 비밀번호가 확인값과 일치하지 않으면 
            		  if( pwd != pwd2) {	  
            			  $('#pwdResult').text("비밀번호와 확인값이 일치하지 않습니다.").show().fadeOut(1000);
            			  
            		  } else if (pwd == '') {
            			  $('#pwdResult').text("비밀번호를 반드시 입력하세요.").show().fadeOut(1000);
            		  }
